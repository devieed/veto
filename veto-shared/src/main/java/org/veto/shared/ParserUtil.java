...
public class ParserUtil {
    ...
    public static String replaceWithMap(String sourceString, Map<String, Object> param) {
        if (sourceString == null || sourceString.trim().isEmpty() || param == null) {
            return sourceString;
        }
    ...
    public static Set<String> findPlaceHolderKeys(String sourceString, Pattern pattern) {
        Set<String> placeHolderSet = new ConcurrentSkipListSet<>();
        if (sourceString == null || sourceString.trim().isEmpty() || pattern == null) {
